  ...
  return (
    <div className="mt-8 space-y-8">
      ...
      <div className="card-rk p-6">
        ...
        {isCreateFormOpen ? (
          <div className="mt-6 grid gap-3 md:grid-cols-[1fr_1.5fr_0.7fr_1fr_1fr_1fr_auto]">
            ...
            <select className={selectClassName} style={selectStyle} value={newTaxCode.taxType} onChange={(e) => setNewTaxCode((prev) => ({ ...prev, taxType: e.target.value as TaxTypeValue }))}>
            ...
            visibleTaxCodeRows.map((row) => (
              <div key={row.id} className="rounded-3xl border border-white/10 bg-black/20 p-4">
                <div className="grid gap-3 md:grid-cols-[1fr_1.5fr_0.7fr_1fr_1fr_1fr_auto] md:items-center">
                  ...
                  <select className={selectClassName} style={selectStyle} value={row.taxType} onChange={(e) => updateRow(row.id, { taxType: e.target.value as TaxTypeValue })}>
                    <option value="SERVICE">Service Tax</option>
                    <option value="SALES">Sales Tax</option>
                  </select>

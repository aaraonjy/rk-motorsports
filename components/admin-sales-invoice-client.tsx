                      ...
                      <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        {selectedProduct?.batchTracking ? (
                          <div className="md:col-span-2">
                            ...
                            />
                            {line.inventoryProductId && line.locationId && !isGeneratedLine && !loadingBatches[index] && (availableBatches[index] || []).length === 0 && !line.batchNo ? (
                        ...
                        {selectedProduct?.serialNumberTracking ? (
                          <div className="md:col-span-2">
                            ...
                            />
                            {line.inventoryProductId && line.locationId && (!selectedProduct.batchTracking || line.batchNo) && !isGeneratedLine && !loadingSerials[index] && (availableSerials[index] || []).length === 0 && line.serialNos.length === 0 ? (

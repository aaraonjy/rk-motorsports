  ...
  return (
    ...
    >
      ...
      <div className="mt-auto pt-4">
        {suitableLabel ? (
          <span className="mt-4 inline-flex items-center justify-center rounded-full border border-white/10 px-3 py-1 text-xs font-medium text-white/60 text-center">
            {suitableLabel}
          </span>
        ) : null}
      </div>

    ...
    <section className="section-pad">
      <div className="container-rk max-w-4xl">
        ...
        <p className="mt-4 max-w-2xl text-white/70">
          Fill in your vehicle details, tuning request, and upload your original ECU file. <br />
        ...
        {!customProduct ? (
          ...
          <form
            ...
            className="card-rk mt-8 grid gap-5 p-6 md:grid-cols-2"
          >
            ...
            {/* 🔥 TRUST BOX */}
            <div className="md:col-span-2 rounded-xl border border-white/10 bg-white/5 p-4 text-sm text-white/70">
              ...
              <ul className="space-y-1">
                ...
                <li>• We will contact you to confirm compatibility and details</li>
              </ul>
            </div>

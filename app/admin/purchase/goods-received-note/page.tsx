...
import { AdminGoodsReceivedNoteClient } from "@/components/purchase/admin-goods-received-note-client";
...
export default async function AdminGoodsReceivedNotePage() {

...
const DOC_TYPE = "PR" as PurchaseDocType;
const TITLE = "Purchase Return";
const TITLE_LOWER = "purchase return";
const LIST_PATH = "/admin/purchase/purchase-return";
const SUMMARY_TITLE = "Purchase Return Summary";
const PRODUCT_NOTE = "Purchase return lines are shown below for review and checking.";

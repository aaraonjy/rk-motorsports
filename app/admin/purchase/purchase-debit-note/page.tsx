...
import { AdminPurchaseDebitNoteClient } from "@/components/purchase/admin-purchase-debit-note-client";
...
export default async function AdminPurchaseInvoicePage() {
  ...
  const data = await loadSharedData("PDN" as PurchaseDocType);

  return (
    <section className="section-pad">
      <div className="container-rk max-w-7xl">
        <AdminPurchaseDebitNoteClient

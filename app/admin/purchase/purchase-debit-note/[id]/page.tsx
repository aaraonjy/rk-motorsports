...
const DOC_TYPE = "PDN" as PurchaseDocType;
const TITLE = "Purchase Debit Note";
const TITLE_LOWER = "purchase debit note";
const LIST_PATH = "/admin/purchase/purchase-debit-note";
const SUMMARY_TITLE = "Purchase Debit Note Summary";
const PRODUCT_NOTE = "Purchase debit note lines are shown below for review and checking.";

...
const DOC_TYPE = "CP" as PurchaseDocType;
const TITLE = "Cash Purchase";
const TITLE_LOWER = "cash purchase";
const LIST_PATH = "/admin/purchase/cash-purchase";
const SUMMARY_TITLE = "Cash Purchase Summary";
const PRODUCT_NOTE = "Cash purchase lines are shown below for review and checking.";

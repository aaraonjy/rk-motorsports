...
import { AdminCashPurchaseClient } from "@/components/purchase/admin-cash-purchase-client";
...
export default async function AdminPurchaseInvoicePage() {
  ...
  const data = await loadSharedData("CP" as PurchaseDocType);

  return (
    <section className="section-pad">
      <div className="container-rk max-w-7xl">
        <AdminCashPurchaseClient

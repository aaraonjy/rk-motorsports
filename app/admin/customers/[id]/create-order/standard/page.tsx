...
export default async function AdminCustomerStandardCreateOrderPage({
  params,
      ...
      <div className="container-rk max-w-6xl">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <h1 className="mt-3 text-4xl font-bold">Create Standard Tuning Order</h1>
            <p className="mt-4 text-white/70">
              Create a tuning order for the selected customer using the shared
              form in admin mode.
            </p>
          </div>

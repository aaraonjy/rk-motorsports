...
export default async function CustomerReportPage({ searchParams }: CustomerReportPageProps) {
  ...
  const paginatedCustomers = paginateItems(customers, page, pageSize);
        ...
        <div className="mt-8 space-y-4">
          ...
          <div className="card-rk overflow-hidden">
            <div className="flex flex-col gap-3 border-b border-white/10 px-6 py-5 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-white/60">
                  Showing {paginatedCustomers.totalCount} record{paginatedCustomers.totalCount === 1 ? "" : "s"}.
                </p>
              </div>
            </div>

            {paginatedCustomers.totalCount === 0 ? (
            ...
            <PaginationControls
              ...
              startIndex={paginatedCustomers.startIndex}
              endIndex={paginatedCustomers.endIndex}
              itemLabel="record"
            />
          </div>
        </div>

      ...
      <div className="container-rk">
        ...
        <div className="mt-8 space-y-4">
          ...
          <div className="card-rk overflow-hidden">
            <div className="flex flex-col gap-3 border-b border-white/10 px-6 py-5 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-white/60">
                  Showing {paginatedRows.totalCount} grouped record{paginatedRows.totalCount === 1 ? "" : "s"}.
                </p>
              </div>
            </div>
            ...
            <PaginationControls
              basePath="/admin/reports/revenue-summary"
              baseParams={{ status, orderType, viewBy, dateFrom, dateTo }}

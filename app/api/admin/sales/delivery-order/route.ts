    ...
    const created = await db.$transaction(async (tx) => {
      ...
      const deliveryOrder = await tx.salesTransaction.create({
        data: {
          ...
          deliveryAddressLine1: data.customer.deliveryAddressLine1,
          deliveryAddressLine2: data.customer.deliveryAddressLine2,
          deliveryAddressLine3: data.customer.deliveryAddressLine3,
          deliveryAddressLine4: data.customer.deliveryAddressLine4,
          deliveryCity: data.customer.deliveryCity,
          deliveryPostCode: data.customer.deliveryPostCode,
          deliveryCountryCode: data.customer.deliveryCountryCode,
